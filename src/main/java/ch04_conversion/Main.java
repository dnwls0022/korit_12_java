...
public class Main {
    public static void main(String[] args) {
        ...
        int cast5 = 100;    // 얘는 # 2로 하시오
        // 지시 사항 다운캐스팅하는 방법을 업캐스팅 방법 # 1 ,2를 참조하여
        ...
        /*
            ...
            -> 현재는 '기본 자료형'을 기준으로 예시를 들었지만 나중에는 '참조 자료형'
